      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://github.com/heyauri/oss-gallery" className="text-gray-400 hover:text-purple-600">
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-4 text-sm text-gray-500 md:mt-0">
            An{" "}
            <a
              className="font-semibold text-purple-600 underline-offset-4 transition-colors hover:underline"
              href="https://github.com/heyauri/oss-gallery"
              target="_blank"
            >
              open-source
            </a>{" "}
